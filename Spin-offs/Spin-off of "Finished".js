// Link:  https://www.khanacademy.org/computer-programming/spin-off-of-finished/4532128924958720
// Created:  02/05/2016 18:08
...
curveVertex(x-296, y-110);
curveVertex(x-302, y-115);
...
// Smoother nose
//bezier(-142, 32, -123, 34, -203, 96, -204, 14);
noFill();
...
// Nose curl near ear
for (var i = 17; i > -13.2; i-=0.2) {
    pushMatrix();
    translate(x-287, y+-109);
    rotate(-237);
    rotate(-i*20.1);
